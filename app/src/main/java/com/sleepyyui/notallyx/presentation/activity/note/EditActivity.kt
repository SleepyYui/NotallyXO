package com.sleepyyui.notallyx.presentation.activity.note
...
import com.sleepyyui.notallyx.data.NotallyDatabase
import com.sleepyyui.notallyx.data.model.Audio
import com.sleepyyui.notallyx.data.model.FileAttachment
import com.sleepyyui.notallyx.data.model.Folder
import com.sleepyyui.notallyx.data.model.NoteViewMode
import com.sleepyyui.notallyx.data.model.Type
import com.sleepyyui.notallyx.data.model.isImageMimeType
import com.sleepyyui.notallyx.databinding.ActivityEditBinding
import com.sleepyyui.notallyx.presentation.activity.LockedActivity
import com.sleepyyui.notallyx.presentation.activity.main.MainActivity
import com.sleepyyui.notallyx.presentation.activity.main.MainActivity.Companion.EXTRA_FRAGMENT_TO_OPEN
import com.sleepyyui.notallyx.presentation.activity.main.MainActivity.Companion.EXTRA_SKIP_START_VIEW_ON_BACK
import com.sleepyyui.notallyx.presentation.activity.main.fragment.DisplayLabelFragment.Companion.EXTRA_DISPLAYED_LABEL
import com.sleepyyui.notallyx.presentation.activity.note.SelectLabelsActivity.Companion.EXTRA_SELECTED_LABELS
import com.sleepyyui.notallyx.presentation.activity.note.reminders.RemindersActivity
import com.sleepyyui.notallyx.presentation.add
import com.sleepyyui.notallyx.presentation.addFastScroll
import com.sleepyyui.notallyx.presentation.addIconButton
import com.sleepyyui.notallyx.presentation.bindLabels
import com.sleepyyui.notallyx.presentation.displayEditLabelDialog
import com.sleepyyui.notallyx.presentation.displayFormattedTimestamp
import com.sleepyyui.notallyx.presentation.extractColor
import com.sleepyyui.notallyx.presentation.getQuantityString
import com.sleepyyui.notallyx.presentation.hideKeyboard
import com.sleepyyui.notallyx.presentation.isLightColor
...
import com.sleepyyui.notallyx.presentation.setLightStatusAndNavBar
import com.sleepyyui.notallyx.presentation.setupProgressDialog
import com.sleepyyui.notallyx.presentation.showKeyboard
import com.sleepyyui.notallyx.presentation.showToast
import com.sleepyyui.notallyx.presentation.view.misc.NotNullLiveData
import com.sleepyyui.notallyx.presentation.view.note.ErrorAdapter
import com.sleepyyui.notallyx.presentation.view.note.action.Action
import com.sleepyyui.notallyx.presentation.view.note.action.AddActions
import com.sleepyyui.notallyx.presentation.view.note.action.AddBottomSheet
import com.sleepyyui.notallyx.presentation.view.note.action.MoreActions
import com.sleepyyui.notallyx.presentation.view.note.action.MoreNoteBottomSheet
import com.sleepyyui.notallyx.presentation.view.note.audio.AudioAdapter
import com.sleepyyui.notallyx.presentation.view.note.preview.PreviewFileAdapter
import com.sleepyyui.notallyx.presentation.view.note.preview.PreviewImageAdapter
import com.sleepyyui.notallyx.presentation.viewmodel.ExportMimeType
import com.sleepyyui.notallyx.presentation.viewmodel.NotallyModel
import com.sleepyyui.notallyx.presentation.viewmodel.preference.DateFormat
import com.sleepyyui.notallyx.presentation.viewmodel.preference.ListItemSort
import com.sleepyyui.notallyx.presentation.viewmodel.preference.NotesSortBy
import com.sleepyyui.notallyx.presentation.widget.WidgetProvider
import com.sleepyyui.notallyx.utils.FileError
import com.sleepyyui.notallyx.utils.backup.exportNotes
import com.sleepyyui.notallyx.utils.changehistory.ChangeHistory
import com.sleepyyui.notallyx.utils.getMimeType
import com.sleepyyui.notallyx.utils.getUriForFile
import com.sleepyyui.notallyx.utils.log
import com.sleepyyui.notallyx.utils.mergeSkipFirst
import com.sleepyyui.notallyx.utils.observeSkipFirst
import com.sleepyyui.notallyx.utils.shareNote
import com.sleepyyui.notallyx.utils.showColorSelectDialog
import com.sleepyyui.notallyx.utils.wrapWithChooser
import java.io.File
