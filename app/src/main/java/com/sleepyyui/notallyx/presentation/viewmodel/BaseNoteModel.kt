package com.sleepyyui.notallyx.presentation.viewmodel
...
import com.sleepyyui.notallyx.data.dao.BaseNoteDao
import com.sleepyyui.notallyx.data.dao.CommonDao
import com.sleepyyui.notallyx.data.dao.LabelDao
import com.sleepyyui.notallyx.data.dao.NoteReminder
import com.sleepyyui.notallyx.data.imports.ImportException
import com.sleepyyui.notallyx.data.imports.ImportProgress
import com.sleepyyui.notallyx.data.imports.ImportSource
import com.sleepyyui.notallyx.data.imports.NotesImporter
import com.sleepyyui.notallyx.data.model.Attachment
import com.sleepyyui.notallyx.data.model.Audio
import com.sleepyyui.notallyx.data.model.BaseNote
import com.sleepyyui.notallyx.data.model.Content
import com.sleepyyui.notallyx.data.model.Converters
import com.sleepyyui.notallyx.data.model.FileAttachment
import com.sleepyyui.notallyx.data.model.Folder
import com.sleepyyui.notallyx.data.model.Header
import com.sleepyyui.notallyx.data.model.Item
import com.sleepyyui.notallyx.data.model.Label
import com.sleepyyui.notallyx.data.model.SearchResult
import com.sleepyyui.notallyx.data.model.toNoteIdReminders
import com.sleepyyui.notallyx.presentation.activity.main.fragment.settings.SettingsFragment.Companion.EXTRA_SHOW_IMPORT_BACKUPS_FOLDER
import com.sleepyyui.notallyx.presentation.getQuantityString
import com.sleepyyui.notallyx.presentation.restartApplication
...
import com.sleepyyui.notallyx.presentation.viewmodel.preference.BasePreference
import com.sleepyyui.notallyx.presentation.viewmodel.preference.BiometricLock
import com.sleepyyui.notallyx.presentation.viewmodel.preference.NotallyXPreferences
import com.sleepyyui.notallyx.presentation.viewmodel.preference.NotallyXPreferences.Companion.EMPTY_PATH
import com.sleepyyui.notallyx.presentation.viewmodel.preference.NotallyXPreferences.Companion.START_VIEW_DEFAULT
import com.sleepyyui.notallyx.presentation.viewmodel.preference.NotallyXPreferences.Companion.START_VIEW_UNLABELED
import com.sleepyyui.notallyx.presentation.viewmodel.preference.Theme
import com.sleepyyui.notallyx.utils.ActionMode
import com.sleepyyui.notallyx.utils.Cache
import com.sleepyyui.notallyx.utils.MIME_TYPE_JSON
import com.sleepyyui.notallyx.utils.backup.clearAllFolders
import com.sleepyyui.notallyx.utils.backup.clearAllLabels
import com.sleepyyui.notallyx.utils.backup.exportAsZip
import com.sleepyyui.notallyx.utils.backup.exportPdfFile
import com.sleepyyui.notallyx.utils.backup.exportPlainTextFile
import com.sleepyyui.notallyx.utils.backup.getPreviousLabels
import com.sleepyyui.notallyx.utils.backup.getPreviousNotes
import com.sleepyyui.notallyx.utils.backup.importZip
import com.sleepyyui.notallyx.utils.backup.readAsBackup
import com.sleepyyui.notallyx.utils.cancelNoteReminders
import com.sleepyyui.notallyx.utils.deleteAttachments
import com.sleepyyui.notallyx.utils.getBackupDir
import com.sleepyyui.notallyx.utils.getExternalImagesDirectory
import com.sleepyyui.notallyx.utils.log
import com.sleepyyui.notallyx.utils.scheduleNoteReminders
import com.sleepyyui.notallyx.utils.security.decryptDatabase
import com.sleepyyui.notallyx.utils.security.encryptDatabase
import java.io.File
