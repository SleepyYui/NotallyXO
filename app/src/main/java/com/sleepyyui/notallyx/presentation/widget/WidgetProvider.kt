package com.sleepyyui.notallyx.presentation.widget
...
import com.sleepyyui.notallyx.presentation.activity.ConfigureWidgetActivity
import com.sleepyyui.notallyx.presentation.activity.note.EditActivity.Companion.EXTRA_SELECTED_BASE_NOTE
...
import com.sleepyyui.notallyx.presentation.getContrastFontColor
import com.sleepyyui.notallyx.presentation.view.note.listitem.findChildrenPositions
import com.sleepyyui.notallyx.presentation.view.note.listitem.findParentPosition
...
import com.sleepyyui.notallyx.utils.embedIntentExtras
import com.sleepyyui.notallyx.utils.getOpenNotePendingIntent
import com.sleepyyui.notallyx.utils.isSystemInDarkMode
...
class WidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        private const val EXTRA_MODIFIED_NOTES = "com.sleepyyui.notallyx.EXTRA_MODIFIED_NOTES"
        private const val ACTION_NOTES_MODIFIED = "com.sleepyyui.notallyx.ACTION_NOTE_MODIFIED"

        const val ACTION_OPEN_NOTE = "com.sleepyyui.notallyx.ACTION_OPEN_NOTE"
        const val ACTION_OPEN_LIST = "com.sleepyyui.notallyx.ACTION_OPEN_LIST"
        const val ACTION_SELECT_NOTE = "com.sleepyyui.notallyx.ACTION_SELECT_NOTE"

        const val ACTION_CHECKED_CHANGED = "com.sleepyyui.notallyx.ACTION_CHECKED_CHANGED"
        const val EXTRA_POSITION = "notallyx.intent.extra.com.sleepyyui.notallyx.EXTRA_POSITION"
    }
}
