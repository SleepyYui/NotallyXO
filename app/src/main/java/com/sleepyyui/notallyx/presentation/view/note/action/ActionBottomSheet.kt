package com.sleepyyui.notallyx.presentation.view.note.action
...
import com.sleepyyui.notallyx.databinding.BottomSheetActionBinding
import com.sleepyyui.notallyx.presentation.dp
import com.sleepyyui.notallyx.presentation.getColorFromAttr
...
open class ActionBottomSheet(
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val dialog =
            BottomSheetDialog(
                requireContext(),
                com.sleepyyui.notallyx.R.style.ThemeOverlay_App_BottomSheetDialog,
            )
        color?.let {
            dialog.window?.apply {
