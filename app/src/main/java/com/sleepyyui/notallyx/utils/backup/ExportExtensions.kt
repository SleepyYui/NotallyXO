package com.sleepyyui.notallyx.utils.backup
...
import com.sleepyyui.notallyx.data.NotallyDatabase.Companion.DATABASE_NAME
...
import com.sleepyyui.notallyx.data.model.toHtml
import com.sleepyyui.notallyx.data.model.toJson
import com.sleepyyui.notallyx.data.model.toTxt
...
import com.sleepyyui.notallyx.presentation.viewmodel.BackupFile
...
import com.sleepyyui.notallyx.utils.SUBFOLDER_AUDIOS
import com.sleepyyui.notallyx.utils.SUBFOLDER_FILES
import com.sleepyyui.notallyx.utils.SUBFOLDER_IMAGES
import com.sleepyyui.notallyx.utils.createChannelIfNotExists
import com.sleepyyui.notallyx.utils.createReportBugIntent
import com.sleepyyui.notallyx.utils.getExportedPath
import com.sleepyyui.notallyx.utils.getExternalAudioDirectory
import com.sleepyyui.notallyx.utils.getExternalFilesDirectory
import com.sleepyyui.notallyx.utils.getExternalImagesDirectory
import com.sleepyyui.notallyx.utils.getUriForFile
import com.sleepyyui.notallyx.utils.listZipFiles
import com.sleepyyui.notallyx.utils.log
import com.sleepyyui.notallyx.utils.logToFile
import com.sleepyyui.notallyx.utils.nameWithoutExtension
import com.sleepyyui.notallyx.utils.recreateDir
import com.sleepyyui.notallyx.utils.removeTrailingParentheses
import com.sleepyyui.notallyx.utils.security.decryptDatabase
import com.sleepyyui.notallyx.utils.security.getInitializedCipherForDecryption
...
const val AUTO_BACKUP_WORK_NAME = "com.sleepyyui.notallyx.AutoBackupWork"
