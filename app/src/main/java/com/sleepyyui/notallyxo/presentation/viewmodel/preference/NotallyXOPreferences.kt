package com.sleepyyui.notallyxo.presentation.viewmodel.preference
...
import com.sleepyyui.notallyxo.utils.backup.importPreferences
import com.sleepyyui.notallyxo.utils.toCamelCase
import org.json.JSONArray
import org.json.JSONObject

class NotallyXOPreferences private constructor(private val context: Context) {
    ...
    companion object {
        private const val TAG = "NotallyXOPreferences"
        const val EMPTY_PATH = "emptyPath"
        const val START_VIEW_DEFAULT = ""
        const val START_VIEW_UNLABELED = "com.sleepyyui.notallyxo.startview.UNLABELED"

        @Volatile private var instance: NotallyXOPreferences? = null

        fun getInstance(context: Context): NotallyXOPreferences {
            return instance
                ?: synchronized(this) {
                    val instance = NotallyXOPreferences(context)
...
val NotallyXOPreferences.autoSortByCheckedEnabled
