...
import com.sleepyyui.notallyxo.data.dao.NoteIdReminder
import com.sleepyyui.notallyxo.data.imports.txt.extractListItems
import com.sleepyyui.notallyxo.data.imports.txt.findListSyntaxRegex
...
import com.sleepyyui.notallyxo.data.model.SpanRepresentation
import com.sleepyyui.notallyxo.data.model.Type
import com.sleepyyui.notallyxo.data.model.attachmentsDifferFrom
import com.sleepyyui.notallyxo.data.model.copy
import com.sleepyyui.notallyxo.data.model.deepCopy
import com.sleepyyui.notallyxo.presentation.activity.note.reminders.RemindersActivity.Companion.NEW_REMINDER_ID
import com.sleepyyui.notallyxo.presentation.applySpans
...
import com.sleepyyui.notallyxo.utils.Event
import com.sleepyyui.notallyxo.utils.FileError
import com.sleepyyui.notallyxo.utils.backup.checkBackupOnSave
import com.sleepyyui.notallyxo.utils.backup.importAudio
import com.sleepyyui.notallyxo.utils.backup.importFile
import com.sleepyyui.notallyxo.utils.cancelNoteReminders
import com.sleepyyui.notallyxo.utils.cancelReminder
...
import com.sleepyyui.notallyxo.utils.getTempAudioFile
import com.sleepyyui.notallyxo.utils.scheduleReminder
import java.io.File
...
class NotallyModel(private val app: Application) : AndroidViewModel(app) {
    ...
    private val database = NotallyXODatabase.getDatabase(app)
