...
import com.sleepyyui.notallyxo.presentation.activity.ConfigureWidgetActivity
import com.sleepyyui.notallyxo.presentation.activity.note.EditActivity.Companion.EXTRA_SELECTED_BASE_NOTE
import com.sleepyyui.notallyxo.presentation.activity.note.EditListActivity
import com.sleepyyui.notallyxo.presentation.activity.note.EditNoteActivity
import com.sleepyyui.notallyxo.presentation.extractColor
import com.sleepyyui.notallyxo.presentation.getContrastFontColor
import com.sleepyyui.notallyxo.presentation.view.note.listitem.findChildrenPositions
import com.sleepyyui.notallyxo.presentation.view.note.listitem.findParentPosition
...
import com.sleepyyui.notallyxo.utils.embedIntentExtras
import com.sleepyyui.notallyxo.utils.getOpenNotePendingIntent
import com.sleepyyui.notallyxo.utils.isSystemInDarkMode
...
class WidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun updateWidget(
            ...
            if (!locked) {
                val database = NotallyXODatabase.getDatabase(context).value
                MainScope().launch {
                    withContext(Dispatchers.IO) {
        ...
        private const val EXTRA_MODIFIED_NOTES = "com.sleepyyui.notallyxo.EXTRA_MODIFIED_NOTES"
        private const val ACTION_NOTES_MODIFIED = "com.sleepyyui.notallyxo.ACTION_NOTE_MODIFIED"

        const val ACTION_OPEN_NOTE = "com.sleepyyui.notallyxo.ACTION_OPEN_NOTE"
        const val ACTION_OPEN_LIST = "com.sleepyyui.notallyxo.ACTION_OPEN_LIST"
        const val ACTION_SELECT_NOTE = "com.sleepyyui.notallyxo.ACTION_SELECT_NOTE"

        const val ACTION_CHECKED_CHANGED = "com.sleepyyui.notallyxo.ACTION_CHECKED_CHANGED"
        const val EXTRA_POSITION = "notallyxo.intent.extra.com.sleepyyui.notallyxo.EXTRA_POSITION"
    }
}
