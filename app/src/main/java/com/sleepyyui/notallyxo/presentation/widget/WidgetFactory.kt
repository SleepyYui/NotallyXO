...
import com.sleepyyui.notallyxo.presentation.widget.WidgetProvider.Companion.extractWidgetColors
import com.sleepyyui.notallyxo.presentation.widget.WidgetProvider.Companion.getWidgetCheckedChangeIntent
import com.sleepyyui.notallyxo.presentation.widget.WidgetProvider.Companion.getWidgetOpenNoteIntent
import com.sleepyyui.notallyxo.presentation.widget.WidgetProvider.Companion.getWidgetSelectNoteIntent

class WidgetFactory(
    private val app: NotallyXOApplication,
    private val id: Long,
    ...
    private val preferences = NotallyXOPreferences.getInstance(app)

    init {
        NotallyXODatabase.getDatabase(app).observeForever { database = it }
    }
