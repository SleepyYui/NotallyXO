...
import com.sleepyyui.notallyxo.databinding.ActivityPlayAudioBinding
...
import com.sleepyyui.notallyxo.utils.audio.AudioPlayService
import com.sleepyyui.notallyxo.utils.audio.LocalBinder
...
class PlayAudioActivity : LockedActivity<ActivityPlayAudioBinding>() {
    ...
    companion object {
        const val EXTRA_AUDIO = "notallyxo.intent.extra.AUDIO"
    }
}
