...
import com.sleepyyui.notallyxo.presentation.hideKeyboardOnFocusedItem
import com.sleepyyui.notallyxo.presentation.setOnNextAction
import com.sleepyyui.notallyxo.presentation.showKeyboardOnFocusedItem
import com.sleepyyui.notallyxo.presentation.view.note.action.MoreListActions
import com.sleepyyui.notallyxo.presentation.view.note.action.MoreListBottomSheet
import com.sleepyyui.notallyxo.presentation.view.note.listitem.HighlightText
import com.sleepyyui.notallyxo.presentation.view.note.listitem.ListManager
import com.sleepyyui.notallyxo.presentation.view.note.listitem.adapter.CheckedListItemAdapter
import com.sleepyyui.notallyxo.presentation.view.note.listitem.adapter.ListItemAdapter
import com.sleepyyui.notallyxo.presentation.view.note.listitem.adapter.ListItemHighlight
import com.sleepyyui.notallyxo.presentation.view.note.listitem.adapter.ListItemVH
import com.sleepyyui.notallyxo.presentation.view.note.listitem.init
import com.sleepyyui.notallyxo.presentation.view.note.listitem.setItems
import com.sleepyyui.notallyxo.presentation.view.note.listitem.sorting.ListItemParentSortCallback
import com.sleepyyui.notallyxo.presentation.view.note.listitem.sorting.SortedItemsList
import com.sleepyyui.notallyxo.presentation.view.note.listitem.splitByChecked
import com.sleepyyui.notallyxo.presentation.view.note.listitem.toMutableList
import com.sleepyyui.notallyxo.presentation.viewmodel.preference.NotallyXOPreferences
import com.sleepyyui.notallyxo.presentation.viewmodel.preference.autoSortByCheckedEnabled
import com.sleepyyui.notallyxo.utils.findAllOccurrences
import com.sleepyyui.notallyxo.utils.indices
import com.sleepyyui.notallyxo.utils.mapIndexed
...
class EditListActivity : EditActivity(Type.LIST), MoreListActions {
    ...
    override fun setStateFromModel(savedInstanceState: Bundle?) {
        ...
        adapter =
            ListItemAdapter(
                ...
                elevation,
                NotallyXOPreferences.getInstance(application),
                listManager,
                false,
                binding.ScrollView,
            )
    ...
    companion object {
        private const val EXTRA_ITEM_POS = "notallyxo.intent.extra.ITEM_POS"
        private const val EXTRA_SELECTION_START = "notallyxo.intent.extra.EXTRA_SELECTION_START"
        private const val EXTRA_SELECTION_END = "notallyxo.intent.extra.EXTRA_SELECTION_END"
    }
}
