package com.sleepyyui.notallyxo.presentation.activity.main
...
import com.sleepyyui.notallyxo.databinding.ActivityMainBinding
...
import com.sleepyyui.notallyxo.presentation.activity.main.fragment.NotallyFragment
...
import com.sleepyyui.notallyxo.presentation.viewmodel.BaseNoteModel.Companion.CURRENT_LABEL_EMPTY
import com.sleepyyui.notallyxo.presentation.viewmodel.BaseNoteModel.Companion.CURRENT_LABEL_NONE
...
class MainActivity : LockedActivity<ActivityMainBinding>() {
    ...
    private fun setupMenu() {
        binding.NavigationView.menu.apply {
            ...
            NotallyXODatabase.getDatabase(application).observe(this@MainActivity) { database ->
    ...
    companion object {
        const val EXTRA_FRAGMENT_TO_OPEN = "notallyxo.intent.extra.FRAGMENT_TO_OPEN"
        const val EXTRA_SKIP_START_VIEW_ON_BACK = "notallyxo.intent.extra.SKIP_START_VIEW_ON_BACK"
    }
}
