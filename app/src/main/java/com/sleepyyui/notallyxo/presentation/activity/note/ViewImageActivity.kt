...
import com.sleepyyui.notallyxo.databinding.ActivityViewImageBinding
...
import com.sleepyyui.notallyxo.presentation.view.note.image.ImageAdapter
...
class ViewImageActivity : LockedActivity<ActivityViewImageBinding>() {
    ...
    companion object {
        const val EXTRA_POSITION = "notallyxo.intent.extra.POSITION"
        const val CURRENT_IMAGE = "CURRENT_IMAGE"
        const val EXTRA_DELETED_IMAGES = "notallyxo.intent.extra.DELETED_IMAGES"
    }
}
