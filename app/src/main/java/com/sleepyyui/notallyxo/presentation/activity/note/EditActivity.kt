...
import com.sleepyyui.notallyxo.data.model.isImageMimeType
import com.sleepyyui.notallyxo.databinding.ActivityEditBinding
...
import com.sleepyyui.notallyxo.presentation.activity.main.MainActivity.Companion.EXTRA_FRAGMENT_TO_OPEN
import com.sleepyyui.notallyxo.presentation.activity.main.MainActivity.Companion.EXTRA_SKIP_START_VIEW_ON_BACK
import com.sleepyyui.notallyxo.presentation.activity.main.fragment.DisplayLabelFragment.Companion.EXTRA_DISPLAYED_LABEL
import com.sleepyyui.notallyxo.presentation.activity.note.SelectLabelsActivity.Companion.EXTRA_SELECTED_LABELS
...
import com.sleepyyui.notallyxo.presentation.addFastScroll
import com.sleepyyui.notallyxo.presentation.addIconButton
import com.sleepyyui.notallyxo.presentation.bindLabels
import com.sleepyyui.notallyxo.presentation.displayEditLabelDialog
import com.sleepyyui.notallyxo.presentation.displayFormattedTimestamp
import com.sleepyyui.notallyxo.presentation.extractColor
import com.sleepyyui.notallyxo.presentation.getQuantityString
import com.sleepyyui.notallyxo.presentation.hideKeyboard
import com.sleepyyui.notallyxo.presentation.isLightColor
...
import com.sleepyyui.notallyxo.presentation.setLightStatusAndNavBar
import com.sleepyyui.notallyxo.presentation.setupProgressDialog
import com.sleepyyui.notallyxo.presentation.showKeyboard
...
import com.sleepyyui.notallyxo.presentation.view.note.ErrorAdapter
import com.sleepyyui.notallyxo.presentation.view.note.action.Action
import com.sleepyyui.notallyxo.presentation.view.note.action.AddActions
import com.sleepyyui.notallyxo.presentation.view.note.action.AddBottomSheet
import com.sleepyyui.notallyxo.presentation.view.note.action.MoreActions
import com.sleepyyui.notallyxo.presentation.view.note.action.MoreNoteBottomSheet
import com.sleepyyui.notallyxo.presentation.view.note.audio.AudioAdapter
import com.sleepyyui.notallyxo.presentation.view.note.preview.PreviewFileAdapter
import com.sleepyyui.notallyxo.presentation.view.note.preview.PreviewImageAdapter
...
import com.sleepyyui.notallyxo.presentation.viewmodel.preference.ListItemSort
...
import com.sleepyyui.notallyxo.utils.changehistory.ChangeHistory
import com.sleepyyui.notallyxo.utils.getMimeType
import com.sleepyyui.notallyxo.utils.getUriForFile
import com.sleepyyui.notallyxo.utils.log
import com.sleepyyui.notallyxo.utils.mergeSkipFirst
import com.sleepyyui.notallyxo.utils.observeSkipFirst
...
abstract class EditActivity(private val type: Type) :
        ...
        lifecycleScope.launch {
            val colors =
                withContext(Dispatchers.IO) {
                        NotallyXODatabase.getDatabase(this@EditActivity, observePreferences = false)
                            .value
                            .getBaseNoteDao()
                            .getAllColors()
                    }
    ...
    companion object {
        ...
        const val EXTRA_SELECTED_BASE_NOTE = "notallyxo.intent.extra.SELECTED_BASE_NOTE"
        const val EXTRA_NOTE_ID = "notallyxo.intent.extra.NOTE_ID"
        const val EXTRA_FOLDER_FROM = "notallyxo.intent.extra.FOLDER_FROM"
        const val EXTRA_FOLDER_TO = "notallyxo.intent.extra.FOLDER_TO"
