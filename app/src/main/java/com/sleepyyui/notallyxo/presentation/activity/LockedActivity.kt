package com.sleepyyui.notallyxo.presentation.activity
...
abstract class LockedActivity<T : ViewBinding> : AppCompatActivity() {
    ...
    private lateinit var notallyXApplication: NotallyXOApplication
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        notallyXApplication = (application as NotallyXOApplication)
        preferences = NotallyXOPreferences.getInstance(application)
