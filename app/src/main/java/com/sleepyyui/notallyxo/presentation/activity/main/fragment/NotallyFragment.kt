...
import com.sleepyyui.notallyxo.databinding.FragmentNotesBinding
import com.sleepyyui.notallyxo.presentation.activity.main.MainActivity
import com.sleepyyui.notallyxo.presentation.activity.main.fragment.SearchFragment.Companion.EXTRA_INITIAL_FOLDER
import com.sleepyyui.notallyxo.presentation.activity.main.fragment.SearchFragment.Companion.EXTRA_INITIAL_LABEL
import com.sleepyyui.notallyxo.presentation.activity.note.EditActivity.Companion.EXTRA_FOLDER_FROM
import com.sleepyyui.notallyxo.presentation.activity.note.EditActivity.Companion.EXTRA_FOLDER_TO
import com.sleepyyui.notallyxo.presentation.activity.note.EditActivity.Companion.EXTRA_NOTE_ID
...
abstract class NotallyFragment : Fragment(), ItemListener {
    ...
    companion object {
        private const val EXTRA_SCROLL_POS = "notallyxo.intent.extra.SCROLL_POS"
        private const val EXTRA_SCROLL_OFFSET = "notallyxo.intent.extra.SCROLL_OFFSET"
    }
}
