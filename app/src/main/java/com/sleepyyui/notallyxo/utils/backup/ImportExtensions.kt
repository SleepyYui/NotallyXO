...
import com.sleepyyui.notallyxo.data.imports.ImportStage
...
import com.sleepyyui.notallyxo.data.model.parseToColorString
import com.sleepyyui.notallyxo.presentation.getQuantityString
import com.sleepyyui.notallyxo.presentation.showToast
import com.sleepyyui.notallyxo.presentation.viewmodel.NotallyModel.FileType
...
import com.sleepyyui.notallyxo.utils.clearDirectory
import com.sleepyyui.notallyxo.utils.copyToFile
import com.sleepyyui.notallyxo.utils.determineMimeTypeAndExtension
...
import com.sleepyyui.notallyxo.utils.getFileName
import com.sleepyyui.notallyxo.utils.log
import com.sleepyyui.notallyxo.utils.mimeTypeToFileExtension
import com.sleepyyui.notallyxo.utils.rename
    ...
    try {
        val importedNotes =
            withContext(Dispatchers.IO) {
                ...
                zipFile.extractFile(
                    NotallyXODatabase.DATABASE_NAME,
                    databaseFolder.path,
                    NotallyXODatabase.DATABASE_NAME,
                )
                ...
                val database =
                    SQLiteDatabase.openDatabase(
                        File(databaseFolder, NotallyXODatabase.DATABASE_NAME).path,
                        null,
                ...
                val notallyDatabase =
                    NotallyXODatabase.getDatabase(this@importZip, observePreferences = false).value
